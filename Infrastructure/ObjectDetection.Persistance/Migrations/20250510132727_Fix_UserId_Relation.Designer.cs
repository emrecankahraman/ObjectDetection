...
namespace ObjectDetection.Persistance.Migrations
{
    ...
    [Migration("20250510132727_Fix_UserId_Relation")]
    partial class Fix_UserId_Relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ObjectDetection.Domain.Entities.BoundingBox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ObjectDetection.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ObjectDetection.Domain.Entities.BoundingBox", b =>
                {
                    b.HasOne("ObjectDetection.Domain.Entities.Image", "Image")
            ...
            modelBuilder.Entity("ObjectDetection.Domain.Entities.Image", b =>
                {
                    b.HasOne("ObjectDetection.Domain.Entities.AppUser", "User")
                        .WithMany("Images")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
